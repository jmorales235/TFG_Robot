...
<Project Type="Project" LVVersion="19008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="MAIN_Robot_Master.vi" Type="VI" URL="../MAIN_Robot_Master.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Main.vi" Type="VI" URL="../../LVPROJ_CONFIG_ESTACION/Main.vi"/>
			<Item Name="Coordenadas_estacion.ctl" Type="VI" URL="../../LVPROJ_CONFIG_ESTACION/Type_defs/Coordenadas_estacion.ctl"/>
			<Item Name="state_config_estacion.ctl" Type="VI" URL="../../LVPROJ_CONFIG_ESTACION/Type_defs/state_config_estacion.ctl"/>
			<Item Name="Set_coordenadas_estacion.vi" Type="VI" URL="../../LVPROJ_CONFIG_ESTACION/VI&apos;s/Set_coordenadas_estacion.vi"/>
			<Item Name="state_coordenadas.ctl" Type="VI" URL="../../LVPROJ_CONFIG_ESTACION/Type_defs/state_coordenadas.ctl"/>
			...
			<Item Name="Copia_fichero_a_directorio.vi" Type="VI" URL="../../LVPROJ_CONFIG_ESTACION/VI&apos;s/Copia_fichero_a_directorio.vi"/>
			<Item Name="MAIN_CALLED.vi" Type="VI" URL="../../LVPROJ_TRASPASO_ASICS/LABVIEW_STANDALONE/MAIN_CALLED.vi"/>
			<Item Name="Estados_TRASPASO.ctl" Type="VI" URL="../../LVPROJ_TRASPASO_ASICS/LABVIEW_STANDALONE/TYPE&apos;S DEF/Estados_TRASPASO.ctl"/>
			<Item Name="INPUT_TRASPASO_ASICS.ctl" Type="VI" URL="../../LVPROJ_TRASPASO_ASICS/LABVIEW_STANDALONE/TYPE&apos;S DEF/INPUT_TRASPASO_ASICS.ctl"/>
			<Item Name="Configuracion_estación.ctl" Type="VI" URL="../../LVPROJ_CONFIG_ESTACION/Type_defs/Configuracion_estación.ctl"/>
			<Item Name="OUTPUTS_TRASPASO_ASICS.ctl" Type="VI" URL="../../LVPROJ_TRASPASO_ASICS/LABVIEW_STANDALONE/TYPE&apos;S DEF/OUTPUTS_TRASPASO_ASICS.ctl"/>
			<Item Name="Check_bandejas.vi" Type="VI" URL="../../LVPROJ_TRASPASO_ASICS/LABVIEW_STANDALONE/VI&apos;S/Check_bandejas.vi"/>
			<Item Name="configEstacion_toArduino_TRASPASO.vi" Type="VI" URL="../../LVPROJ_TRASPASO_ASICS/LABVIEW_STANDALONE/VI&apos;S/configEstacion_toArduino_TRASPASO.vi"/>
			<Item Name="datosTraspaso_to_Arduino.vi" Type="VI" URL="../../LVPROJ_TRASPASO_ASICS/LABVIEW_STANDALONE/VI&apos;S/datosTraspaso_to_Arduino.vi"/>
			<Item Name="incrementar_&amp;checkfinal_traspaso.vi" Type="VI" URL="../../LVPROJ_TRASPASO_ASICS/LABVIEW_STANDALONE/VI&apos;S/incrementar_&amp;checkfinal_traspaso.vi"/>
			<Item Name="State_QR.ctl" Type="VI" URL="../../LVPROJ_LEER_QR/LABVIEW/TYPE&apos;S DEF/State_QR.ctl"/>
			<Item Name="MAIN_CALLED_leerQR.vi" Type="VI" URL="../../LVPROJ_LEER_QR/LABVIEW/MAIN_CALLED_leerQR.vi"/>
			<Item Name="INPUT LECTURA_QR.ctl" Type="VI" URL="../../LVPROJ_LEER_QR/LABVIEW/TYPE&apos;S DEF/INPUT LECTURA_QR.ctl"/>
			<Item Name="OUTPUTS_lecturaQR.ctl" Type="VI" URL="../../LVPROJ_LEER_QR/LABVIEW/TYPE&apos;S DEF/OUTPUTS_lecturaQR.ctl"/>
			<Item Name="configEstacion_toArduino_QR.vi" Type="VI" URL="../../LVPROJ_LEER_QR/LABVIEW/VI&apos;S/configEstacion_toArduino_QR.vi"/>
			<Item Name="datosLecturaQR_to_Arduino.vi" Type="VI" URL="../../LVPROJ_LEER_QR/LABVIEW/VI&apos;S/datosLecturaQR_to_Arduino.vi"/>
			<Item Name="incrementar_CheckfinalQR.vi" Type="VI" URL="../../LVPROJ_LEER_QR/LABVIEW/VI&apos;S/incrementar_CheckfinalQR.vi"/>
			<Item Name="wait_&amp;ackChar.vi" Type="VI" URL="../../LVPROJ_LEER_QR/LABVIEW/VI&apos;S/wait_&amp;ackChar.vi"/>
			<Item Name="MAIN_CALLED_TESTASICS.vi" Type="VI" URL="../../LVPROJ_TESTASICS/LABVIEW/MAIN_CALLED_TESTASICS.vi"/>
			<Item Name="State_main.ctl" Type="VI" URL="../../LVPROJ_TESTASICS/LABVIEW/Type_defs/State_main.ctl"/>
			<Item Name="INPUT TEST.ctl" Type="VI" URL="../../LVPROJ_TESTASICS/LABVIEW/Type_defs/INPUT TEST.ctl"/>
			<Item Name="OUTPUTS_TEST.ctl" Type="VI" URL="../../LVPROJ_TESTASICS/LABVIEW/Type_defs/OUTPUTS_TEST.ctl"/>
			<Item Name="Enviar_configEstacion_Arduino.vi" Type="VI" URL="../../LVPROJ_TESTASICS/LABVIEW/VI&apos;s/Enviar_configEstacion_Arduino.vi"/>
			<Item Name="Enviar_datosTest_Arduino.vi" Type="VI" URL="../../LVPROJ_TESTASICS/LABVIEW/VI&apos;s/Enviar_datosTest_Arduino.vi"/>
			<Item Name="IncrementarCuenta_&amp;checkFinal.vi" Type="VI" URL="../../LVPROJ_TESTASICS/LABVIEW/VI&apos;s/IncrementarCuenta_&amp;checkFinal.vi"/>
			...
			<Item Name="WRITE_LOG_FILE.vi" Type="VI" URL="../../LVPROJ_TESTASICS/LABVIEW/VI&apos;s/WRITE_LOG_FILE.vi"/>
			<Item Name="Escribir_Fichero.vi" Type="VI" URL="../../LVPROJ_TESTASICS/LABVIEW/VI&apos;s/Escribir_Fichero.vi"/>
		</Item>
