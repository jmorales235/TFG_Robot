...
long pulsos_z_coger_bandeja = (pulsos_rev/200)*3700; //Estaba en *3500
long pulsos_z_soltar_bandeja = (pulsos_rev/200)*3500;
...
void loop()
{
  ...
  pulsos_entrada_x = (546+entrada_x*36.75)*(pulsos_rev/200); // (550,725) es la primera celda y hay 37 y 34 pulsos de separación entre cada una en los ejes X e Y, respectivamente.
  pulsos_entrada_y = (659-entrada_y*33.75)*(pulsos_rev/200); //Antes el paso era de 33.625

  pulsos_salidaOK_x = (935+salidaOK_x*36.75)*(pulsos_rev/200); //Pulsos desde el origen a la celda de salida de la bandeja OK (con bandejas juntas es 537)
  pulsos_salidaOK_y = (659-salidaOK_y*33.75)*(pulsos_rev/200);

  pulsos_salidaNOK_x = (1323+salidaNOK_x*36.75)*(pulsos_rev/200); //Pulsos desde el origen a la celda de salida de la bandeja NOK (con bandejas juntas es 925)
  pulsos_salidaNOK_y = (659-salidaNOK_y*33.75)*(pulsos_rev/200);
...
//    delay(1000);
    ...
    delay(100);
    movimiento(pul_y,pulsos_entrada_y,espera);
    delay(100);
...
//    delay(100);
    ...
    digitalWrite(dir_y,LOW);
    delay(100);
    movimiento(pul_y,entrada_socket_y,espera);
    delay(100);
...
//      delay(1000);
      digitalWrite(dir_y,HIGH);
      delay(100);
      movimiento(pul_y,socket_salidaOK_y,espera);
      delay(100);
...
//      delay(100);
      ...
      digitalWrite(dir_y,LOW);
      delay(100);
      movimiento(pul_y,pulsos_salidaOK_y,espera);
      delay(100);
    ...
    else
    {
      ...
      digitalWrite(dir_y,HIGH);
      delay(100);
      movimiento(pul_y,socket_salidaNOK_y,espera);
      delay(100);
...
//      delay(100);
      ...
      digitalWrite(dir_y,LOW);
      delay(100);
      movimiento(pul_y,pulsos_salidaNOK_y,espera);
      delay(100);
